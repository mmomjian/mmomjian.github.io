...
function display_map() {
    var is_both = (location.search == '?map_type=both') ? 1 : 0;

    // Use longitude so map is continent-aligned on start
    // Align vertically on Tropic of Cancer
//    var myLatlng = new google.maps.LatLng(23.43716, 11);
    ...
    // image is 12x20
    var marker_img_p = new google.maps.MarkerImage('/main/img/mm_20_p.png');
    var marker_img_f = new google.maps.MarkerImage('/main/img/mm_20_f.png');
    // offset -9
    var marker_img_f_offset = new google.maps.MarkerImage('/main/img/mm_20_f.png',
	null, null, new google.maps.Point(-3,20), null);

    // http://stackoverflow.com/questions/7842730/change-marker-size-in-google-maps-v3
    // shadow image size is 22x20
    var marker_shadow = new google.maps.MarkerImage('/main/img/mm_20_shadow.png',
	null, null, new google.maps.Point(7,20), null);
    // offset -9
    var marker_shadow_offset = new google.maps.MarkerImage('/main/img/mm_20_shadow.png',
	null, null, new google.maps.Point(-2,20), null);
    ...
    function createMarker(map_pins, lat, lng, locstr) {
      ...
      var marker = new google.maps.Marker({
        ...
        icon: (map_pins == matthew_momjian_geo_locations ? marker_img_p :
